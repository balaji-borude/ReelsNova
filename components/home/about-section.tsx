    ...
    <section className="py-24 bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Left side - Content */}
          <div>
            <span className="text-primary-500 font-medium text-sm uppercase tracking-wider">About ReelsNova</span>
            <h2
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-neutral-800/50 border border-neutral-700 rounded-2xl p-6 hover:border-primary-500/50 transition-colors"
              >
