...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center px-4 py-2">
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-neutral-400 mt-2">
                Join millions of creators on ReelsNova
              </p>
            </div>
            ...
            <form className="space-y-5" onSubmit={submitHandler}>
              ...
              {/* <div className="flex items-start gap-2">
                <input
                  type="checkbox"
                  id="terms"
                  className="w-4 h-4 mt-1 rounded border-neutral-700 bg-neutral-800 text-rose-500 focus:ring-rose-500"
                />
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                <button className="flex items-center justify-center gap-2 border border-neutral-700 hover:bg-neutral-800 text-white bg-transparent py-3 rounded-md transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed">
                ...
                <button className="flex items-center justify-center gap-2 border border-neutral-700 hover:bg-neutral-800 text-white bg-transparent py-3 rounded-md transition cursor-pointer">
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 24 24"
