        ...
        <div className="w-full max-w-md">
          <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-neutral-400 mt-2">Join millions of creators on ReelsNova</p>
            </div>
            ...
            <form className="space-y-5">
              ...
              <div className="flex items-start gap-2">
                <input
                  type="checkbox"
                  id="terms"
                  className="w-4 h-4 mt-1 rounded border-neutral-700 bg-neutral-800 text-primary-500 focus:ring-primary-500"
                />
              ...
              <Button type="submit" className="w-full bg-primary-500 hover:bg-primary-600 text-white py-6">
                Create Account
              </Button>
            </form>
